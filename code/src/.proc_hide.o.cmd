cmd_/home/shan/android-kernel/HOOK/src/proc_hide.o := clang -Wp,-MMD,/home/shan/android-kernel/HOOK/src/.proc_hide.o.d -nostdinc -isystem /home/shan/android-kernel/prebuilts-master/clang/host/linux-x86/clang-r416183b/lib64/clang/12.0.5/include -I/home/shan/android-kernel/common/arch/arm64/include -I./arch/arm64/include/generated -I/home/shan/android-kernel/common/include -I./include -I/home/shan/android-kernel/common/arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I/home/shan/android-kernel/common/include/uapi -I./include/generated/uapi -include /home/shan/android-kernel/common/include/linux/kconfig.h -include /home/shan/android-kernel/common/include/linux/compiler_types.h -D__KERNEL__ -mlittle-endian -DKASAN_SHADOW_SCALE_SHIFT= -Qunused-arguments -fmacro-prefix-map=/home/shan/android-kernel/common/= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 --target=aarch64-linux-gnu --prefix=/usr/bin/aarch64-linux-gnu- --gcc-toolchain=/usr -fno-integrated-as -Werror=unknown-warning-option -mgeneral-regs-only -DCONFIG_CC_HAS_K_CONSTRAINT=1 -Wno-psabi -fno-asynchronous-unwind-tables -fno-unwind-tables -mbranch-protection=pac-ret+leaf+bti -Wa,-march=armv8.5-a -DARM64_ASM_ARCH='"armv8.5-a"' -ffixed-x18 -DKASAN_SHADOW_SCALE_SHIFT= -fno-delete-null-pointer-checks -Wno-frame-address -Wno-address-of-packed-member -O2 -Wframe-larger-than=2048 -fstack-protector-strong -Werror -Wno-format-invalid-specifier -Wno-gnu -mno-global-merge -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -ftrivial-auto-var-init=zero -enable-trivial-auto-var-init-zero-knowing-it-will-be-removed-from-clang -g -gdwarf-4 -fsanitize=shadow-call-stack -flto=thin -fsplit-lto-unit -fvisibility=default -fsanitize=cfi -fsanitize-cfi-cross-dso -fno-sanitize-cfi-canonical-jump-tables -fno-sanitize-blacklist -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-array-bounds -fno-strict-overflow -fno-stack-check -Werror=date-time -Werror=incompatible-pointer-types -Wno-initializer-overrides -Wno-format -Wno-sign-compare -Wno-format-zero-length -Wno-pointer-to-enum-cast -Wno-tautological-constant-out-of-range-compare -Wno-enum-compare-conditional -Wno-enum-enum-conversion -I/home/shan/android-kernel/HOOK/include -DMODULE_NAME=\"vfs_core\" -O2 -fno-strict-aliasing -fno-common -fno-delete-null-pointer-checks  -fsanitize=array-bounds -fsanitize=local-bounds -fsanitize-undefined-trap-on-error  -DMODULE  -DKBUILD_BASENAME='"proc_hide"' -DKBUILD_MODNAME='"vfs_core"' -D__KBUILD_MODNAME=kmod_vfs_core -c -o /home/shan/android-kernel/HOOK/src/proc_hide.o /home/shan/android-kernel/HOOK/src/proc_hide.c

source_/home/shan/android-kernel/HOOK/src/proc_hide.o := /home/shan/android-kernel/HOOK/src/proc_hide.c

deps_/home/shan/android-kernel/HOOK/src/proc_hide.o := \
  ...
  /home/shan/android-kernel/HOOK/include/teargame_stealth.h \
  /home/shan/android-kernel/common/include/linux/proc_fs.h \
    $(wildcard include/config/proc/pid/arch/status.h) \

/home/shan/android-kernel/HOOK/src/proc_hide.o: $(deps_/home/shan/android-kernel/HOOK/src/proc_hide.o)
